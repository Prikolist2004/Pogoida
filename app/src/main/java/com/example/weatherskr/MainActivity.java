package com.example.weatherskr;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view_city = (TextView) findViewById(R.id.etName);
        ...
        search_floating.setOnClickListener(new View.OnClickListener() {
            ...
            private void api_key(final String City) {
                ...
                Request request = new Request.Builder()
                        .url("https://api.openweathermap.org/data/2.5/weather?q=" + City + "&units=metric&appid=38f7e658af37700577c9934397d0ab5d")
                        .get()
                        .build();
            ...
            private void setText(final TextView view_city, final String city) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
